...
.factory('recipeService',function($firebaseArray) {
	var fb = new Firebase('https://carlab-v1.firebaseio.com/menu');
...
.factory('fireBaseData', function($firebase,$firebaseArray) {
	var ref = new Firebase("https://carlab-v1.firebaseio.com/"),
    refCart = new Firebase("https://carlab-v1.firebaseio.com/cart"),
    refUser = new Firebase("https://carlab-v1.firebaseio.com/users"),
    refCategory = new Firebase("https://carlab-v1.firebaseio.com/category"),
    refOrder = new Firebase("https://carlab-v1.firebaseio.com/orders"),
    refFeatured = new Firebase("https://carlab-v1.firebaseio.com/featured"),
    refMenu = new Firebase("https://carlab-v1.firebaseio.com/menu"),
    refSlider = new Firebase("https://carlab-v1.firebaseio.com/slider")
    ;
